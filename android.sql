...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-03-2023 a las 08:07:25
...
INSERT INTO `entrada` (`idEntrada`, `precio`, `idUsuario`, `idPelicula`) VALUES
(1, '5.00', 2, 1),
(2, '5.00', 3, 3),
(3, '5.00', 4, 3),
(4, '5.00', 4, 2);
...
INSERT INTO `pelicula` (`idPelicula`, `titulo`, `tematica`, `trailer`, `anio`, `edadRecomendada`, `butacasLibres`, `butacasOcupadas`, `calificacion`, `vecesPuntuado`) VALUES
...
(4, 'Avatar', 'Aventura', 'https://www.youtube.com/watch?v=AZS_d_hS2dM', 2009, 7, 100, 200, '4.20', 783),
